...
interface DeptModalSlice {
    isOpen: boolean;
    isEdit: boolean;
    form: DeptFormState;
    setForm: Dispatch<SetStateAction<DeptFormState>>;
...
interface Props {
    modal: DeptModalSlice;
    periodes: PeriodeOption[];
}

const DepartemenFormModal = ({ modal, periodes }: Props) => {
                ...
                <form onSubmit={submit} className="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setForm({ ...form, namaDepartemen: e.target.value })}
...
export default DepartemenFormModal;