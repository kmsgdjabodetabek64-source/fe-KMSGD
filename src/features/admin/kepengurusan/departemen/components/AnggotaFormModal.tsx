...
import type { CreateAnggotaDto } from "../../kepengurusanTypes";

interface AnggotaModalSlice {
    isOpen: boolean;
    form: CreateAnggotaDto & { file?: File | null };
    setForm: React.Dispatch<React.SetStateAction<CreateAnggotaDto & { file?: File | null }>>;
    isUploading: boolean;
    close: () => void;
...
interface Props {
    modal: AnggotaModalSlice;
}

const AnggotaFormModal = ({ modal }: Props) => {
