interface PengumumanImageFieldProps {
    preview: string | null;
    file: File | null;
...
export default function PengumumanImageField({ preview, file, onChange, onRemove }: PengumumanImageFieldProps) {
            ...
            {preview && (
                <div className="mt-1.5 flex items-center justify-between">
                    <p className="text-xs text-neutral-600 truncate">
                        {file ? file.name : "Gambar saat ini"}
                    </p>
                    <button
                        type="button"
                        onClick={onRemove}
